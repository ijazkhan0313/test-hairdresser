...
var Ke = (n, e, t) => e in n ? Je(n, e, { enumerable: true, configurable: true, writable: true, value: t }) : n[e] = t;
var l = (n, e, t) => (Ke(n, typeof e != "symbol" ? e + "" : e, t), t);
var Ae;
var be = typeof window < "u";
var nt = (n) => typeof n == "string";
var rt = () => {
};
...
function Le(n, e = false, t = "Timeout") {
...
function Ce(n) {
  return et() ? (tt(n), true) : false;
}
function fe(n) {
  return typeof n == "function" ? ve(n) : C(n);
}
function ye(n, e = false) {
  function t(c, { flush: h = "sync", deep: g = false, timeout: v, throwOnTimeout: N } = {}) {
    let _ = null;
  ...
  function r(c, h) {
    if (!Ie(c))
      return t((z) => z === c, h);
    const { flush: g = "sync", deep: v = false, timeout: N, throwOnTimeout: _ } = h != null ? h : {};
    let P = null;
...
function lt(n, e, t = {}) {
  ...
  return r && (i.value = true, be && s()), Ce(d), {
    isPending: i,
    start: s,
    stop: d
  };
...
var Oe = (n, e, t) => e in n ? ct(n, e, { enumerable: true, configurable: true, writable: true, value: t }) : n[e] = t;
var p = (n, e) => {
  for (var t in e || (e = {}))
...
function vt(n, ...e) {
  ...
  const {
    ...
    initialData: s,
    timeout: u
  } = a, f = de(), c = de(), h = de(), g = C(false), v = C(false), N = C(false), _ = C(null), P = ue(null), q = ue(null), M = ue(s), z = ve(() => r && v.value);
  let H, $;
  const ke = () => {
    r && H && H.abort();
  }, se = (F) => {
  ...
  u && ($ = lt(ke, u, { immediate: false }));
  const ee = async (F = false) => {
    var T;
    se(true), q.value = null, _.value = null, N.value = false, H = void 0, r && (H = new AbortController(), H.signal.onabort = () => N.value = true, i = E(p({}, i), {
      signal: H.signal
    }));
    const k = {
      method: o.method,
    ...
    if (a.beforeFetch && Object.assign(A, await a.beforeFetch(A)), R || !d)
      return se(false), Promise.resolve(null);
    let L = null;
  ...
  function ce() {
    return new Promise((F, T) => {
      ot(g).toBe(true).then(() => F(te)).catch((k) => T(k));
    });
  }
  function V(F) {
    return () => {
...
var ze = (n, e, t) => e in n ? bt(n, e, { enumerable: true, configurable: true, writable: true, value: t }) : n[e] = t;
var Wt = (n, e) => {
  for (var t in e || (e = {}))
